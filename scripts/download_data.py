...
def parse_args():
    p = argparse.ArgumentParser(description="Download SPY/VIX and build RV target + combined dataset.")
    ...
    p.add_argument("--window", type=int, default=None, help="Realized vol window (days)." )
...
def main():
    ...
    if args.window: cfg.realized_vol_window = args.window
