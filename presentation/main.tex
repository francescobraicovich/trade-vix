...
\begin{frame}{LSTM Architecture: Gating Mechanisms}
    ...
    \begin{columns}[T]
        \begin{column}{0.3\textwidth}
            \textbf{Forget Gate:}
            \begin{itemize}
                \item What to discard (long term)
        ...
        \begin{column}{0.3\textwidth}
            \textbf{Output Gate:}
            \begin{itemize}
                \item What to output (short term)
...
\end{frame}
\begin{frame}{LSTM: Visual Overview}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{pic/lstm.png}
    \end{figure}
\end{frame}
...
\begin{frame}{Final Rankings: All Seven Strategies (h=30)}
    ...
    \vspace{0.2cm}
    \begin{center}
        \footnotesize \textit{Out-of-sample test set: 2020--2025 (never-seen data)}
    \end{center}
